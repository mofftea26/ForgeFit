...
import { Stepper } from "@/features/Create/components/Stepper";
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: bg }}>
      <Stepper index={step} count={stepsTotal}>
        {/* STEP 1: Basics (scrollable, keyboard-safe) */}
        <KeyboardAvoidingView
          style={{ flex: 1 }}
        ...
        {/* STEP 2: Cover image (center icon matches text color) */}
        <View style={{ flex: 1 }}>
          <H2>Cover image</H2>
          <View style={{ height: 12 }} />
          <Pressable
      ...
      {/* Bottom controls (full-width split) */}
      <View
        style={{
          flexDirection: "row",
          gap: 10,
